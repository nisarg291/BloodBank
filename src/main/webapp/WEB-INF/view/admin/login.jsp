    ...
    <div class="sufee-login d-flex align-content-center flex-wrap">
        <div class="container">
            <div class="login-content">
                ...
                <h1>Admin Login</h1>
                    <f:form id="signupForm5" method="post" modelAttribute="adminVO"
									class=" right-text-label-form" action="/verifyAdmin">
                        <div class="form-group">
                            <label>Admin Email</label>
                            <f:input type="email" path="adminEmail" class="form-control" placeholder="Admin Email"/>
                        </div>
                        <div class="form-group">
                            <label>Admin Password</label>
                            <f:input type="password" path="adminPassword" class="form-control" placeholder="Password"/>
                        </div>
                        <div class="checkbox">
                            <label>
