				...
				<div class="row">
					<div class=" col-md-12">
						<div class="card card-shadow mb-4">
							...
							<div class="card-body">
								<f:form id="signupForm" method="post"
									class=" right-text-label-form" modelAttribute="bloodGroupVO" action="/insertBloodGroup">

									<div class="form-group row">
										<label class="col-sm-4 control-label" for="bloodbank name">bloodbank
											name</label>
										<div class="col-sm-5">
												<c:forEach items="${bloodbankList}" var="i">
															<f:input type="text" value="${i.bloodbankName}" class="form-control" path="bloodbankVO.bloodbankName" name="bloodbankname" readonly="True"/>
												</c:forEach>
									...
									<div class="form-group row">
										...
										<div class="col-sm-5">
											<span class="select-wrapper"> 
												<select class="form-control form-control-square" path="bloodGroupType" id="exampleFormControlSelect10">
									...
									<div class="form-group row">
										<label class="col-sm-4 control-label" for="total stock">total
											stock</label>
										<div class="col-sm-5">
											<f:input type="text" path="totalStock" class="form-control" id="total stock" name="total stock" placeholder="total stock" />
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-4 control-label" for="required stock">required
											stock</label>
										<div class="col-sm-5">
											<f:input type="text" class="form-control" path="requiredStock" name="required stock" placeholder="required stock" />
										</div>
									</div>
