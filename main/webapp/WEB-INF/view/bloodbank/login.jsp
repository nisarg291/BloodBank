    ...
    <div class="sufee-login d-flex align-content-center flex-wrap">
        <div class="container">
            <div class="login-content">
                ...
                <h1>BloodBank Login</h1>
                    <f:form id="signupForm4" method="post" modelAttribute="bloodbankVO"
									class=" right-text-label-form" action="/verifyBloodbank">
                        <div class="form-group">
                            <label>UserName</label>
                            <f:input type="text" path="bloodbankUserName" class="form-control" placeholder="User Name"/>
                        </div>
                        <div class="form-group">
                            <label>Password</label>
                            <f:input type="password" path="bloodbankPassword" class="form-control" placeholder="Password"/>
                        </div>
                        <div class="checkbox">
                            <label>
                        ...
                        <div class="register-link m-t-15 text-center">
                            <p>Don't have account ?
                                <a href="/addBloodbank"> Sign Up Here</a>
                            </p>
                        </div>
                    </f:form>
                </div>
